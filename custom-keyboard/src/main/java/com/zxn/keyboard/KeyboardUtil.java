...
//	private Keyboard k3;
    ...
    public KeyboardUtil(Context ctx, View parent, EditText edit) {
        ...
        keyboardView = (CustomKeyboardView) parent.findViewById(R.id.keyboard_view);
    ...
    public KeyboardUtil(Context ctx, EditText edit, CustomKeyboardView keyboardView) {
        this.ctx = ctx;
        this.ed = edit;
        //此处可替换键盘xml
        k1 = new Keyboard(ctx, R.xml.number);
    ...
    public KeyboardUtil(Context ctx, EditText edit) {
        ...
        k1 = new Keyboard(ctx, R.xml.number);
        try {
            keyboardView = (CustomKeyboardView) ((Activity) ctx).findViewById(R.id.keyboard_view);
            keyboardView.setContext(ctx);
            keyboardView.setKeyboard(k1);
            keyboardView.setEnabled(true);
            keyboardView.setPreviewEnabled(false);
